...
Get started with Penfield across your preferred AI platform.
...
- [Quick Reference](penfield-user-quick-reference.md) - User guide for getting the most out of Penfield
- [Example Custom Instructions](example-custom-instructions.md) - Starter template for personalizing your assistant
